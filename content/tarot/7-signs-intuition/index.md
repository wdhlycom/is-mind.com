---
title: "12 Signs Your Intuition Is Trying to Tell You Something"
author: "Luna Vale"
date: "2026-07-01"
tags:
  - intuition
  - carl jung
directory: /tarot/
summary: "What if those random gut feelings and sudden certainties aren't random at all?
  Your body knows things before your mind catches up — and modern neuroscience is finally
  catching on. From Carl Jung's 'perception via the unconscious' to the hundred million
  neurons in your gut, here are twelve unmistakable signals your intuition is trying to
  send you — seven in your mind and behavior, five in your body. How many have you been
  ignoring?"
pin_a: "Your intuition isn't a whisper — it's a language you learned before words."
pin_b: "Ever ignored a gut feeling and later wished you hadn't?"
---

> Your intuition isn't a whisper — it's a language you learned before words, and forgot how to speak.

 ![](illustration-01-three-intelligences.png)
...
![](illustration-03-fox-pattern.png)
---

### 😤 Signal #8: Why Does My Throat Tighten When Something Isn't Right?

**The core answer:** The throat is one of the body's most sensitive truth-detectors. Tightness, constriction, or the urge to keep swallowing often signals that you're holding something back — or that something in your environment doesn't align with what you know to be true.

I've felt this most clearly in conversations where someone was lying — not big lies, just small self-serving distortions. My throat would close before I could name what was off. The body caught the dishonesty before my brain labeled it.

**What to try:** Next time a conversation feels off, check your throat. Tight? Constricted? Needing to clear? Don't analyze — just notice. The body is already ahead of you.

---

### 💪 Signal #9: Why Do My Shoulders Tense Before a Bad Decision?

**The core answer:** The trapezius muscles — the ones that run from your neck across your shoulders — are one of the first places the body stores stress. When they activate in response to a *specific thought* rather than general tension, it's often an intuitive warning.

Here's a simple test. Think about a decision you're avoiding. Now check your shoulders. Up? Carrying tension? Now think about a decision that felt right — something you knew was correct even if it was hard. Do your shoulders release? **That shift is information.** It's not random. It's your body comparing two possible futures and voting with muscle tension.
...
### 🌀 Signal #10: Why Does My Stomach Drop Before Something Matters?

**The core answer:** The gut-brain axis is a direct neural highway, and your stomach carries more serotonin receptors than your brain. When something registers as significant — a decision, a person, a risk — your stomach often signals it before your mind understands why.

Athletes feel this before big games. Speakers feel it before walking on stage. But the same mechanism fires in everyday moments — a conversation with your boss, a date that might matter, a decision you can't quite make. **The stomach drop isn't telling you to run. It's telling you to pay attention.**

---

### 💓 Signal #11: Why Does My Heart Rate Shift Without Explanation?

**The core answer:** The heart has its own intrinsic nervous system — sometimes called the "heart brain." When your heart rate changes in the absence of physical exertion, it's often processing intuitive information before your conscious mind can track it.

Heart rate variability — the natural variation in the space between heartbeats — is one of the most reliable measures of emotional and intuitive coherence. When it suddenly drops, something just registered. HeartMath's research showed the heart responds to emotional stimuli up to six seconds before the brain does. In decision-making, that six-second lead is often the difference between catching an intuitive signal and rationalizing it away.

**What to try:** Place your hand on your chest before a decision — not to check your pulse, just to bring your attention there. Calm? Racing? Heavy? That answer is data.

---

### 🌬️ Signal #12: Why Does My Breath Go Shallow When I'm Off Track?

**The core answer:** Shallow, rapid breathing is the body's arousal signal — it activates when your nervous system detects threat or misalignment. If your breath constricts in response to a specific person, choice, or environment, your body is signaling that something isn't right.

Breathing is one of the fastest-read signals in the body. You can check it in three seconds — no journal, no meditation, no setup.
...
**No interpretation needed. Just data. Your body has been answering your questions all along.**

---

## 🧭 Where This Leaves Us

So we've got twelve signals, each with its own signature:
...
* A throat that tightens when something isn't right
* Shoulders that tense around a specific decision
* A stomach that drops when something matters
* A heart rate that shifts without exertion
* A breath that goes shallow when you're off track
...
---
![](A_dimly_lit_bedroom_at_dawn.png)
...
*Next time: [what happens when you can't tell the difference between fear and intuition](/tarot/fear-vs-intuition/) — that was her next question, and it's the one most people get stuck on.*
