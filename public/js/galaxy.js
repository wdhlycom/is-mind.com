...
(function () {
  ...
  function initGalaxy() {
    // Re-entrant: cancel any previous loop + resize listener before remounting.
    if (rafId) { cancelAnimationFrame(rafId); rafId = null; }
    if (resizeBound) { window.removeEventListener('resize', resize); resizeBound = false; }
  ...
  function onReady() {
    if (document.getElementById('galaxy-canvas')) initGalaxy();
  }
